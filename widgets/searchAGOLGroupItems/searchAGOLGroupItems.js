...
define([
    ...
    function (declare, _WidgetBase, portal, topic, lang, Deferred, nls, leftPanelContent, query, on, domConstruct, domAttr, domClass, domStyle, esriRequest, arcgisUtils, urlUtils) {
        ...
        return declare([_WidgetBase], {
            ...
            postCreate: function () {
                ...
                this.fetchAppIdSettings().then(lang.hitch(this, function () {
